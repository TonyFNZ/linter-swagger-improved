...
describe( 'Linting YAML files', () => {
  ...
  it( 'Handles correct input with no errors', () => {
    const PETSTORE = join( __dirname, 'data', 'petstore.yaml' );
  ...
  it( 'Handles invalid type errors', () => {
    const SAMPLE1 = join( __dirname, 'data', 'sample1.yaml' );
  ...
  it( 'Handles additional property errors', () => {
    const SAMPLE2 = join( __dirname, 'data', 'sample2.yaml' );
  ...
  it( 'Rejects unsupported \'anyOf\' directive', () => {
    const SAMPLE3 = join( __dirname, 'data', 'sample3.yaml' );
  ...
  it( 'Handles bad reference errors', () => {
    const SAMPLE4 = join( __dirname, 'data', 'sample4.yaml' );
  ...
  it( 'Handles errors within an array', () => {
    const SAMPLE5 = join( __dirname, 'data', 'sample5.yaml' );
  ...
  it( 'Handles nested properties with the same name', () => {
    const SAMPLE6 = join( __dirname, 'data', 'sample6.yaml' );
